...
module.exports = {
  rules: {
    ...
    // custom
    'component-name-hyphenation': require('./rules/component-name-hyphenation'),
    'space-line-in-components': require('./rules/space-line-in-components'),
    'space-line-in-template': require('./rules/space-line-in-template'),
    'comma-after-spacing': require('./rules/comma-after-spacing'),
    'multiple-line-import-export': require('./rules/multiple-line-import-export'),
    'if-statement-style': require('./rules/if-statement-style'),
    'space-line-after-brace': require('./rules/space-line-after-brace'),
    'space-line-in-object': require('./rules/space-line-in-object'),
    'no-unnecessary-await': require('./rules/no-unnecessary-await'),
    'space-line-after-declaration': require('./rules/space-line-after-declaration'),
    'pretty-condition': require('./rules/pretty-condition'),
